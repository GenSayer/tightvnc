...
LINK32=link.exe
LINK32_FLAGS=wsock32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib comctl32.lib /nologo /subsystem:windows /incremental:no /pdb:"$(OUTDIR)\WinVNC.pdb" /machine:ARM /out:"$(OUTDIR)\WinVNC.exe" 
LINK32_OBJS= \
...
LINK32=link.exe
LINK32_FLAGS=wsock32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib comctl32.lib /nologo /subsystem:windows /incremental:yes /pdb:"$(OUTDIR)\WinVNC.pdb" /map:"$(INTDIR)\WinVNC.map" /debug /machine:ARM /out:"$(OUTDIR)\WinVNC.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\AdministrationControls.obj" \
	"$(INTDIR)\BuildTime.obj" \
	"$(INTDIR)\d3des.obj" \
...
LINK32=link.exe
LINK32_FLAGS=wsock32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib comctl32.lib /nologo /subsystem:windows /profile /map:"$(INTDIR)\WinVNC.map" /debug /machine:ARM /out:"$(OUTDIR)\WinVNC.exe" 
LINK32_OBJS= \
	"$(INTDIR)\AdministrationControls.obj" \
	"$(INTDIR)\BuildTime.obj" \
	"$(INTDIR)\d3des.obj" \
...
LINK32=link.exe
LINK32_FLAGS=wsock32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib comctl32.lib /nologo /subsystem:windows /incremental:no /pdb:"$(OUTDIR)\AppShare.pdb" /machine:ARM /nodefaultlib:"LIBC" /out:"$(OUTDIR)\AppShare.exe" 
LINK32_OBJS= \
	"$(INTDIR)\AdministrationControls.obj" \
	"$(INTDIR)\BuildTime.obj" \
	"$(INTDIR)\d3des.obj" \
