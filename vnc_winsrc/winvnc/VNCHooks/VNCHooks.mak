...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /nologo /subsystem:windows /dll /incremental:no /pdb:"$(OUTDIR)\VNCHooks.pdb" /machine:ALPHA /def:".\VNCHooks.def" /out:"$(OUTDIR)\VNCHooks.dll" /implib:"$(OUTDIR)\VNCHooks.lib" /libpath:"\\shallot\omni\release\lib\x86_nt_4.0" 
DEF_FILE= \
	".\VNCHooks.def"
LINK32_OBJS= \
	"$(INTDIR)\VNCHooks.obj" \
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /nologo /subsystem:windows /dll /incremental:yes /pdb:"$(OUTDIR)\VNCHooks.pdb" /debug /machine:ALPHA /def:".\VNCHooks.def" /out:"$(OUTDIR)\VNCHooks.dll" /implib:"$(OUTDIR)\VNCHooks.lib" /pdbtype:sept 
DEF_FILE= \
	".\VNCHooks.def"
LINK32_OBJS= \
	"$(INTDIR)\VNCHooks.obj" \
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /nologo /subsystem:windows /dll /profile /debug /machine:ALPHA /def:".\VNCHooks.def" /out:"$(OUTDIR)\VNCHooks.dll" /implib:"$(OUTDIR)\VNCHooks.lib" 
DEF_FILE= \
	".\VNCHooks.def"
LINK32_OBJS= \
	"$(INTDIR)\VNCHooks.obj" \
